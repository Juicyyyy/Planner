...
form.addEventListener('submit', addTask); // при нажатии на кнопку добавляется задача
tasksList.addEventListener('click', deleteTask); // удалить задачу
tasksList.addEventListener('click', doneTask); // выполнить задачу
tasksList.addEventListener('click', fixTask); // изменить задачу
btnClose.addEventListener('click', formOpenClose); // закрыть форму
...
// Вызываем функцию для установки уведомлений
